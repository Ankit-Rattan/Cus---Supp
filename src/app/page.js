...
export default function CustomerSupportPage() {
  ...
  async function analyzeAndSend() {
    ...
    setMessages((prev) => [
      ...
      {
        role: 'agent',
        text: `Thank you for sharing the image. Verdict: ${verdict}. Our quality team is reviewing this.`,
      },
    ]);
      ...
      <div style={styles.container}>
        ...
        <main style={styles.card}>
          ...
          <div style={styles.modeSwitcher}>
            <button
              style={{ ...styles.modeBtn, ...(mode === 'chat' ? styles.modeBtnActiveRed : {}) }}
              ...
              {!isCallActive ? (
                ...
                <div style={styles.activeCallScreen}>
                  ...
                  <div style={styles.callerInfo}>
                    <div style={styles.callerName}>Jay</div>
                  ...
                  {preview && (
                    <div style={styles.previewSection}>
                      ...
                      <button
                        ...
                        disabled={loading}
                      >
                        {loading ? 'Analyzing...' : '🔍 Verify Pizza Quality'}
                      </button>
                    </div>
                  )}
                </div>
